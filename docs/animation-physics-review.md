...
| Limits | Hanging fixed-k oscillator with separate kinetic, elastic and gravitational energy, all in joules on one bar scale. The former cos² bar was incorrectly labelled as pure spring energy despite being potential energy relative to equilibrium. Actual spring energy uses absolute extension. Gravity has a fixed zero at the lower turning point. Net force is mg−kx. | Three-energy conservation, turning-point values, zero-force and proportional geometry tests; browser recheck pending. |
