...
function edges(p,g,c=C.teal,opacity=.7){const o=new T.LineSegments(new T.EdgesGeometry(g),new T.LineBasicMaterial({color:c,transparent:true,opacity,toneMapped:false}));p.add(o);return o;}
