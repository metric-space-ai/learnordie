...
export async function reviewQuestionGrounding(provider: AIProvider, variants: QuestionVariant[], sources: string | readonly string[], deadlineAt: number) {
  ...
  const system = [
      ...
      "Bei Zweifel ablehnen, nicht die Antwort des Autors übernehmen. Gib nur JSON aus: {\"reviews\":[{\"level\":\"4.0\",\"approved\":true,\"answerChecks\":[{\"key\":\"A\",\"verdict\":\"correct\"},{\"key\":\"B\",\"verdict\":\"incorrect\"},{\"key\":\"C\",\"verdict\":\"incorrect\"},{\"key\":\"D\",\"verdict\":\"incorrect\"}],\"sourceIds\":[\"S1.1\"],\"distractors\":[{\"key\":\"B\",\"kind\":\"misconception\"},{\"key\":\"C\",\"kind\":\"misconception\"},{\"key\":\"D\",\"kind\":\"misconception\"}],\"reason\":\"kurze Begründung\"}]}. Exakt vier reviews-Einträge für4.0,3.0,2.0,1.0, JEDER mit vier answerChecks. Die Beispielurteile nicht kopieren: bestimme Schlüssel und Urteile selbst. distractors enthält bei eindeutiger Lösung exakt die drei falschen Schlüssel. Bei Ablehnung approved=false und konkreter Fehler in reason; answerChecks trotzdem vollständig. reason maximal100 Zeichen, keine Wiederholung der Fragen, Antworten oder Quellen."
    ].join(" ");
